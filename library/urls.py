...
# from . import views
from .views import BooksListView, BookCreateView, BookDetailView, BookDeleteView, BookUpdateView, AuthorCreateView, \
...
urlpatterns = [
    ...
    # path('book_detail/<int:book_id>', views.books_detail, name='book_detail'),
]
